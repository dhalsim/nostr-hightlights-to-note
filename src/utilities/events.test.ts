import { getUrlTag } from "./events";

describe('events', () => {
  test('find url in event', () => {
    const eventWithUrl = {
      created_at: 1698326278,
      content: 'nostr:note1whxfpqukvkv3l20td8c0a5kxrv8are7j3kptzkk4def0ta9g0a2q73k0cm\n' +
        'So true! ',
      tags: [
        [
          'q',
    ...
    expect(getUrlTag(eventWithUrl)).toBe("https://medium.com/btc24/nostr-a-decentralised-social-platform-2651930378b9");
  });
})
